...
from .models import (Workshop, Auto, Part, PartPhoto, UserProfile, AuditLog, VoiceSession,
...
class PartPhotoAdmin(admin.ModelAdmin):
    list_display = ['id', 'part', 'source', 'created_at']
    list_filter = ['source', 'created_at']
    search_fields = ['part__name', 'part__barcode']
