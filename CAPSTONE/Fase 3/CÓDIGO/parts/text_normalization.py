...
def limpiar_transcripcion_vosk_robusta(text: str) -> str:
    ...
    comandos = [
        'iniciar el proceso', 'iniciar proceso', 'inicio proceso', 'inicia el proceso',
        'finalizar el proceso', 'finalizar proceso', 'terminar el proceso', 'terminar proceso',
        'detener el proceso', 'detener proceso', 'listo proceso', 'guardar pieza',
        'iniciar', 'finalizar', 'detener', 'guardar'
    ]
    for cmd in comandos:
